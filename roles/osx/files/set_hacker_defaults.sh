...
# Trackpad: enable back/forward with trackpad
defaults write NSGlobalDomain AppleEnableSwipeNavigateWithScrolls -bool true
# Trackpad: swipe between desktops with three fingers
defaults -currentHost write NSGlobalDomain com.apple.trackpad.threeFingerHorizSwipeGesture -int 2
defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad TrackpadThreeFingerHorizSwipeGesture -int 2

# Trackpad: swipe to Mission Control with three fingers
...
# Note: if you’re in the US, replace `EUR` with `USD`
...
# Start finder in home
defaults write com.apple.finder NewWindowTarget -string "PfHm"
defaults write com.apple.finder NewWindowTargetPath -string "file://${HOME}/"

# Do not empty trash securely
...
# Change menu bad date format
defaults write com.apple.menuextra.clock 'DateFormat' -string 'EEE MMM d YYYY HH:mm'

# Don't show external devices on desktop
defaults write com.apple.finder ShowExternalHardDrivesOnDesktop -bool false
defaults write com.apple.finder ShowRemovableMediaOnDesktop -bool false

# Don't show recent tags on Finder sidebar
defaults write com.apple.finder ShowRecentTags -bool false

# ???
defaults write com.apple.finder 'PreferencesWindow.LastSelection' -string 'SDBR'

killall Dock # To apply dock changes immediately
...
# Disable tooltips generated by webkit
# defaults write NSGlobalDomain WebKitShowsToolTipOverTruncatedText -bool false
